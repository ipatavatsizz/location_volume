...
extension GetLocationModelCollection on Isar {
  IsarCollection<LocationModel> get location => this.collection();
}
...
LocationModel _locationModelDeserialize(
  ...
  final object = LocationModel(
    ...
    radius: reader.readDoubleOrNull(offsets[3]) ?? 500,
...
P _locationModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (reader.readDouble(offset)) as P;
    case 3:
      return (reader.readDoubleOrNull(offset) ?? 500) as P;
    case 4:
...
extension LocationModelQuerySortBy
  ...
  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> sortByActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'active', Sort.asc);
    });
  }

  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> sortByActiveDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationModelQuerySortThenBy
  ...
  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> thenByActive() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'active', Sort.asc);
    });
  }

  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> thenByActiveDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'active', Sort.desc);
    });
  }
  ...
  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<LocationModel, LocationModel, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension LocationModelQueryWhereDistinct
  ...
  QueryBuilder<LocationModel, LocationModel, QDistinct> distinctByActive() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocationModel, LocationModel, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension LocationModelQueryProperty
  ...
  QueryBuilder<LocationModel, bool, QQueryOperations> activeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocationModel, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
